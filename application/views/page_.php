   ...
   answer_body[33] = "<div class='md-form'><input type='text' id='q33' class='form-control'></div>";
    ...
    if (section_name == null) {
                ...
                //////Règles générales//////
                           ...
                           if ($('#q1-oui').attr("checked", "checked")) { 
                            var   href_next = base_url + 'index.php/home/page/' + survey + '/3'; //if q1 == oui
                               $("#next_btn").attr("href", href_next);
                           }else   { 
                              var href_next = base_url + 'index.php/home/page/' + survey + '/2'; //if q1 == non
                               $("#next_btn").attr("href", href_next);
                           } 
                           if ($('#q3-oui').attr("checked", "checked")) { 
                               var href_next = base_url + 'index.php/home/page/' + survey + '/4'; //if q1 == oui
                               $("#next_btn").attr("href", href_next);
                           }else  if ($('#q3-non').attr("checked", "checked")) { 
                              var href_next = base_url + 'index.php/home/page/' + survey + '/5'; //if q1 == non
                               $("#next_btn").attr("href", href_next);
                           }
              ...
              else if (id == array_IDs.length || id == 2)
                {
                    ...
                    href_back = base_url + 'index.php/home/page/' + survey + '/1'; //configuration du bouton precedent (q3)
...
//$('#q_form').keydown(function(e){
//    if (e.keyCode === 13) { // If Enter key pressed
//        $(this).trigger('#next_btn');
//    }
//});
//$("#q1-non").keyup(function(event) {
//    if (event.keyCode === 13) {
//        $("#next_btn").click();
//    }
//}); 
