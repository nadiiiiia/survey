                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" id='q9-1-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-2-3'></td>
                                            <td><input type="text" id='q9-2-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-3-3'></td>
                                            <td><input type="text" id='q9-3-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-4-3'></td>
                                            <td><input type="text" id='q9-4-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-5-3'></td>
                                            <td><input type="text" id='q9-5-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-6-3'></td>
                                            <td><input type="text" id='q9-6-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-7-3'></td>
                                            <td><input type="text" id='q9-7-4'></td>
                                        </tr>
                                        <tr>
                                            <td> <input type="text" id='q9-8-3'></td>
                                            <td><input type="text" id='q9-8-4'></td>
                                        </tr>
                                    </tbody>
                                    <!--Table body-->
                                </table>
