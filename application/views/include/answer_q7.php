    ...
    <table class='table'>
        ...
        <tbody>
            <tr>
                ...
                <td><input name="percent" type='text'  id='q7-1-3'></td>
            ...
            <tr>
                ...
                <td><input name="percent" type='text'  class="q7" id='q7-2-3'></td>
                <td class="hidden"><input name="user_id" class="user" type='text'   value="<?php echo $id_user_connected; ?>" ></td>
                    <td class="hidden"><input name="question_id" class="question" type='text'  >
                </td>
            </tr>
            <tr>
                ...
                <td><input name="percent" type='text' class="q7" class="q7" id='q7-3-3'></td>
               <td class="hidden"> <input name="user_id" class="user" type='text'  value="<?php echo $id_user_connected; ?>"  ></td>
            ...
            <tr>
                ...
                <td><input name="percent" class="q7" type='text'  id='q7-4-3'></td>
                   <td class="hidden"> <input name="user_id" class="user" type='text'  value="<?php echo $id_user_connected; ?>"  ></td>
                  <td class="hidden">  <input name="question_id" class="question" type='text' >
                </td>
            </tr>
            <tr>
                ...
                <td><input name="percent" class="q7" type='text'  id='q7-5-3'></td>
               <td class="hidden"> <input name="user_id" class="user" type='text'  value="<?php echo $id_user_connected; ?>" ></td>
                <td class="hidden">    <input name="question_id" class="question" type='text' > </td>
            </tr>
            <tr>
                ...
                <td><select name="unit" id='q7-5-2' class='q7 mdb-select initialized'><option value='tonnes'>Tonnes</option><option value='m3'>m3</option></select></td>
                <td><input class="q7" name="percent" type='text'  id='q7-6-3'></td>
                      <td class="hidden"> <input name="user_id" class="user"  type='text' value="<?php echo $id_user_connected; ?>" ></td>
                  <td class="hidden">  <input  name="question_id" class="question" type='text' ></td>
            </tr>
